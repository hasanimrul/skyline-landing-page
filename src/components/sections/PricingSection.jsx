  ...
  return (
    <div className="main-container py-32 bg-[#f2f5ff] -mt-10">
      <div className="boxed-content flex flex-col items-center gap-10 py-20">
        ...
        <p className="text-center max-w-[60ch] text-lg text-[#6F7CB2]">
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-lg text-[#37447E]">UI Design Kit</p>
        </div>
        <div className="flex flex-col items-center gap-2">
          <p className="text-base text-[#5D6970]">See, One price. Simple.</p>
